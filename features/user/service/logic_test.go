...
func TestGetAll(t *testing.T) {
	...
	returnData := []user.UserCore{{Name: "amin", ID: 1, Email: "amin@a.com", Password: "123123"}}
	token := 1
...
func TestPut(t *testing.T) {
	...
	userMock := new(mocks.UserData)
	input := user.UserCore{Name: "amin", ID: 1, Email: "amin@a.com", Password: "123123"}
	param := 1
	token := 1
...
func TestPostData(t *testing.T) {
	...
	userMock := new(mocks.UserData)
	input := user.UserCore{Name: "amin", Email: "amin@a.com", Password: "123123"}
