...
import (
	"Belajar/CleanCode/features/book"
...
func TestGetAll(t *testing.T) {
	...
	returnData := []book.BookCore{{Title: "one piece", Author: "oda", Publisher: "gramed", Page: 300}}
...
func TestGetById(t *testing.T) {
	...
	bookMock := new(mocks.BookData)
	returnData := book.BookCore{ID: 1, Title: "one piece", Author: "oda", Publisher: "gramed", Page: 300}
	param := 1
...
func TestPut(t *testing.T) {
	...
	bookMock := new(mocks.BookData)
	input := book.BookCore{Title: "one piece", Author: "oda", Publisher: "gramed", Page: 300}
	param := 1
	token := 1
