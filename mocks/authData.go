...
import (
	authorized "Belajar/CleanCode/features/authorized"
...
func (_m *AuthData) LoginUser(email string, password string) (authorized.AuthCore, error) {
	ret := _m.Called(email, password)

	var r0 authorized.AuthCore
	if rf, ok := ret.Get(0).(func(string, string) authorized.AuthCore); ok {
		r0 = rf(email, password)
	} else {
		r0 = ret.Get(0).(authorized.AuthCore)
	}
